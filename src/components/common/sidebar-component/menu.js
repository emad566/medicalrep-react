...
export const MENUITEMS = [
  ...
  //   active: false,
  //   children: [
  //     { path: "/dashboard/users", title: "Default", type: "link" },
  ...
  //     { path: "/charts/apex-chart", type: "link", title: "Apex Chart" },
  //   ],
  // },
  // {
  //   title: "Project",
  ...
  //     { path: "/jobSearch/job-detail/1", title: "Job Details", type: "link" },
  //     { path: "/jobSearch/job-apply/1", title: "Apply", type: "link" },
  //   ],
  // },
  // {
  //   title: "Learning",
