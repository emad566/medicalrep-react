...
import { Customize, Customizer, Color, Pattern, Image, LayoutType, RTLLayout, LTRLayout, SidebarBackgroundSetting, PreviewRealTime, SidebarType, Default, Border, IconColor, DarkLayout, MixLayout, LightLayout, Cancel, Configuration, SidebarSettings } from '../../constant'
...
const ThemeCustomizer = () => {
    ...
    const configDB = useSelector((content: any) => content.Customizer.customizer);
    const color = localStorage.getItem('color')
    // const mix_layout = configDB.color.mix_layout;
    const [layout_type, setLayout_type] = useState<any>(configDB.settings.layout_type);
    ...
    useEffect(() => {
        ...
        //set sidebar wrapper
        if (sidebar_type === null && body_sidebar_type === null && document.querySelector(".page-wrapper") !== null) {
    ...
    const handleSidebarColor = (e: any) => {
    ...
    const handleSidebarSetting = (e: any) => {
        e.preventDefault();
    ...
    const handleCustomizerMix = (e: any) => {
        e.preventDefault();
    ...
    const handleSidebarType = (e: any, wrapper: any, bodyWrapper: any) => {
        e.preventDefault();
    ...
    const colorChangeTheme = (value: any) => {
                        ...
                        <NavItem className="nav nav-tabs" id="myTab" role="tablist">
                            <NavLink className={activeTab1 === '1' ? 'active' : ''} onClick={() => setActiveTab1('1')}>
                                <div className="settings">
                                    <i className="fas fa-cog" onClick={openCustomizer}></i>
                                </div>
                            </NavLink>
                        </NavItem>
                        <NavItem className="nav nav-tabs" id="myTab" role="tablist">
                            <NavLink className={activeTab1 === '2' ? 'active' : ''} onClick={() => setActiveTab1('2')}>
                                <div className="settings color-settings">
                                    <i className="fas fa-fill-drip" onClick={openCustomizer}></i>
                                </div>
                            </NavLink>
                        </NavItem>
                    </Nav>
            ...
            <div className="customizer-contain">
                <div className="tab-content" id="c-pills-tabContent">
                    <div className="customizer-header">
                        <i className="icon-close fas fa-times" onClick={closeCustomizer}></i>
                        <h5>{Customizer}</h5>
                        ...
                        <Modal isOpen={modal} toggle={toggle} className="modal-body" centered={true}>
                            <ModalHeader toggle={toggle}>Title_Here</ModalHeader>
                            <ModalBody>
