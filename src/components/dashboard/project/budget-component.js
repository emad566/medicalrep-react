...
import { pieChartData, pieChartOption } from "../../../data/default";
                ...
                <div className="spent-graph">
                  <div className="d-flex">
                    ...
                    <div className="projects-main mb-0">
                      <div className="xm-mb-peity">{/* <ChartistGraph data={spentChart1Data.data} options={spentChart1Data.options} responsiveOptions={spentChart1Data.responsiveOptions} type={'Bar'} /> */}</div>
                    </div>
                  </div>
                </div>
              </div>
              <div className="card-body spent">
                <div className="spent-graph">
                  <div className="d-flex">
                    ...
                    <div className="projects-main mb-0">
                      <div className="xm-mb-peity">{/* <ChartistGraph data={spentChart2Data.data} options={spentChart2Data.options} responsiveOptions={spentChart2Data.responsiveOptions} type={'Bar'} /> */}</div>
                    </div>
                  </div>
                </div>
              </div>
              <div className="card-body spent">
                <div className="spent-graph">
                  <div className="d-flex">
                    ...
                    <div className="projects-main mb-0">
                      <div className="xm-mb-peity">{/* <ChartistGraph data={spentChart3Data.data} options={spentChart3Data.options} responsiveOptions={spentChart3Data.responsiveOptions} type={'Bar'} /> */}</div>
                    </div>
                  </div>
                </div>
              </div>
