                ...
                <div className="card">
                  ...
                  <div className="card-body">
                    <div className="row">
                      ...
                      <div className="col">
                        <div className="form-group m-t-15 m-b-15 ms-1">
                      ...
                      <div className="col">
                        <div className="form-group m-t-15 m-b-15 ms-1">
                          <div className="checkbox checkbox-success">
                            <input id="checkbox-success-1" type="checkbox" />
                            <label htmlFor="checkbox-success-1">{SuccessState}</label>
                          </div>
                      ...
                      <div className="col">
                        <div className="form-group m-t-15 m-checkbox-inline mb-0 ms-1">
                ...
                <div className="card">
                  ...
                  <div className="card-body">
                    <div className="row">
                      ...
                      <div className="col">
                        <div className="form-group m-t-15 mb-0  ms-1">
