                    ...
                    <div className="row">
                        <div className="col-xl-12">
                            <div className="card">
                                <div className="card-header">
                                    <h5 className="mb-0">
                                        <button className="btn btn-link ps-0" data-toggle="collapse" onClick={() => setIsFilter(!isFilter)}
                        ...
                        <div className="col-xl-12">
                            <div className="card">
                                <div className="card-header">
                                    <h5 className="mb-0">
                                        <button className="btn btn-link ps-0" onClick={() => setIsDesign(!isDesign)}
                        ...
                        <div className="col-xl-12">
                            <div className="card">
                                <div className="card-header">
                                    <h5 className="mb-0">
                                        <button className="btn btn-link ps-0" onClick={() => setIsDevelopment(!isDevelopment)} data-toggle="collapse" data-target="#collapseicon2" aria-expanded="true" aria-controls="collapseicon2">Upcoming Courses</button>
                                    </h5>
                                </div>
                                    ...
                                    <div className="collapse show" id="collapseicon2" aria-labelledby="collapseicon2" data-parent="#accordion">
                                        <div className="upcoming-course card-body">
                                            <div className="d-flex">
                                                <div className="flex-grow-1"><span className="f-w-600">UX Development</span><span className="d-block">Course By <a href="#javascript">Development Team</a></span><span className="d-block"><i className="fa fa-star font-warning"></i><i className="fa fa-star font-warning"></i><i className="fa fa-star font-warning"></i><i className="fa fa-star font-warning"></i><i className="fa fa-star-half-o font-warning"></i></span></div>
                                                <div>
                                                    <h5 className="mb-0 font-primary">18</h5><span className="d-block">Dec</span>
                                                </div>
                                            </div>
                                            <div className="d-flex">
                                                <div className="flex-grow-1"><span className="f-w-600">Business Analyst</span><span className="d-block">Course By <a href="#javascript"> Analyst Team.</a></span><span className="d-block"><i className="fa fa-star font-warning"></i><i className="fa fa-star font-warning"></i><i className="fa fa-star font-warning"></i><i className="fa fa-star font-warning"></i><i className="fa fa-star font-warning"></i></span></div>
                                                <div>
                                                    <h5 className="mb-0 font-primary">28</h5><span className="d-block">Dec</span>
                                                </div>
                                            </div>
                                            <div className="d-flex">
                                                <div className="flex-grow-1"><span className="f-w-600">Web Development</span><span className="d-block">Course By <a href="#javascript">Designer</a></span><span className="d-block"><i className="fa fa-star font-warning"></i><i className="fa fa-star font-warning"></i><i className="fa fa-star font-warning"></i><i className="fa fa-star font-warning"></i><i className="fa fa-star-o font-warning"></i></span></div>
                                                <div>
