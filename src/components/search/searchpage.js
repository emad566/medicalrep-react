            ...
            <div className="container-fluid search-page">
                <div className="card">
                    ...
                    <div className="card-body product-page-main">
                        <Nav tabs className="border-tab nav-primary justify-content-end">
                                ...
                                <div className="row">
                                    <div className="col-xl-6">
                                        ...
                                        <div className="info-block">
                                            <h6>{"Endless Admin is a full featured,premium bootstrap admin template."}</h6>
                                        ...
                                        <div className="card lg-mt mb-0">
                                            <div className="blog-box blog-shadow"><img className="img-fluid" src={one} alt="" />
                                                <div className="blog-details">
                                                    <p className="digits">{"25 May 2023"}</p>
                                ...
                                <div className="row">
                                    <div className="col-xl-6">
                                        ...
                                        <div className="d-flex info-block">
                                            <iframe className="me-3 mb-3" width="200" height="100" src="https://www.youtube.com/embed/CJnfAXlBRTE" title="media" />
                                            <div className="flex-grow-1">
                                                <h6>{"Endless Admin is a full featured,premium bootstrap admin template."}</h6><a href="#javascript">{Endless_Education_Info}</a>
                                                <p>{"endless introduces a IELTS Coaching, TOEFL Coaching, GRE Coaching, GMAT Coaching, SAT Coaching in Surat."}</p>
                                                <div className="star-ratings">
                                                    <ul className="search-info">
                                                        <li>{"2.5 stars"}</li>
                                        ...
                                        <div className="d-flex info-block">
                                            <iframe className="me-3 mb-3" title="media-block" width="200" height="100" src="https://www.youtube.com/embed/-L4gEk7cOfk"></iframe>
                                            <div className="flex-grow-1">
                                        ...
                                        <div className="d-flex info-block">
                                            <iframe className="me-3 mb-3" title="media" width="200" height="100" src="https://www.youtube.com/embed/FZzWGr3ruVw"></iframe>
                                            <div className="flex-grow-1">
                                        ...
                                        <div className="d-flex info-block">
                                            <iframe className="me-3 mb-3" title="media" width="200" height="100" src="https://www.youtube.com/embed/wpmHZspl4EM"></iframe>
                                            <div className="flex-grow-1">
