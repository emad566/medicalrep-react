        ...
        <Fragment>
            <div className="col-xl-12 xl-50">
                <div className="card">
                    <div className="card-header">
                        <h5 className="mb-0">
                            <button className="btn btn-link ps-0" onClick={() => setisIntro(!isIntro)}
                    ...
                    <Collapse isOpen={isIntro}>
                        <div className="card-body filter-cards-view"><span className="f-w-600">{AboutMe} :</span>
                            <p>
            ...
            <div className="col-xl-12 xl-50">
                <div className="card">
                    <div className="card-header">
                        <h5 className="mb-0">
                            <button className="btn btn-link ps-0" onClick={() => setisFollowers(!isFollowers)}
                    ...
                    <Collapse isOpen={isFollowers}>
                        <div className="card-body social-list filter-cards-view">
                            <div className="d-flex">
                                ...
                                <div className="flex-grow-1"><span className="d-block">{BuckyBarnes}</span><a href="#javascript">{AddFriend}</a></div>
                            </div>
                            <div className="d-flex">
                                <img className="img-50 img-fluid m-r-20 rounded-circle" alt="threeImg" src={three} />
                                <div className="flex-grow-1"><span className="d-block">{SarahLoren}</span><a href="#javascript">{AddFriend}</a></div>
                            </div>
                            <div className="d-flex">
                                <img className="img-50 img-fluid m-r-20 rounded-circle" alt="threeImg" src={three} />
                                <div className="flex-grow-1"><span className="d-block">{JasonBorne}</span><a href="#javascript">{AddFriend}</a></div>
                            </div>
                            <div className="d-flex">
                                <img className="img-50 img-fluid m-r-20 rounded-circle" alt="tenImg" src={ten} />
                                <div className="flex-grow-1"><span className="d-block">{ComerenDiaz}</span><a href="#javascript">{AddFriend}</a></div>
                            </div>
                            <div className="d-flex">
                                <img className="img-50 img-fluid m-r-20 rounded-circle" alt="elevenImg" src={eleven} />
                                <div className="flex-grow-1"><span className="d-block">{AndewJon}</span><a href="#javascript">{AddFriend}</a></div>
                            </div>
                        </div>
                    </Collapse>
                </div>
            ...
            <div className="col-xl-12 xl-50">
                <div className="card">
                    <div className="card-header">
                        <h5 className="mb-0">
                            <button className="btn btn-link ps-0" onClick={() => setisFollowings(!isFollowings)}
            ...
            <div className="col-xl-12 xl-50">
                <div className="card">
                    <div className="card-header">
                        <h5 className="mb-0">
                            <button className="btn btn-link ps-0" onClick={() => setisPhotos(!isPhotos)}
            ...
            <div className="col-xl-12 xl-50">
                <div className="card">
                    <div className="card-header">
                        <h5 className="mb-0">
                            <button className="btn btn-link ps-0" onClick={() => setisFriends(!isFriends)}
